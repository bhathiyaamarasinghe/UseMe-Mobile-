...
const key ="AIzaSyCgf9LI3xxoclvxk9svB6ICBFsj4eDupu8";
class ExploreScreen extends Component {
  ...
  componentDidMount() {
    axios.get(`http://192.168.8.101:8000/api/seller/`)
      .then(res => {
  ...
  getdistance = async () => {
    await axios({
      method: "get",
      url: `http://192.168.8.101:8000/api/distance/`
    }).then(response => {
  ...
  address = (data) =>{
    ...
    Geocoder.from(data.description)
      ...
      //  console.log('lat',this.state.lng);
       axios.post('http://192.168.8.101:8000/api/user/', {
        lat: this.state.lat,
        lng: this.state.lng,
