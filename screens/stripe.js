...
function getCreditCardToken(creditCardData){
  ...
  return fetch('https://api.stripe.com/v1/tokens', {
    headers: {
      ...
      Authorization: `Bearer ${pk_test_51IY3QACRORjhYbiIgH2yShGAZacdsDEeM4sG2gtxsgzjuK3CRcWJhY5FAFRzeq0Xh5iiHQ776c1NfOR1gOLxZmFF00woxLdok3}`
    },
    ...
    const card = {
      ...
      return fetch('https://api.stripe.com/v1/charges', {
        headers: {
          ...
          'Content-Type': 'application/x-www-form-urlencoded',
          // Use the Stripe publishable key as Bearer
          Authorization: `Bearer ${sk_test_51IY3QACRORjhYbiIGrq9oMM5D4W8RpkzMLFtlzseFJo6ZMJoZvocFlNfJtGAWkMnOLAZxbpJdq2hMmYFYWG9GbXT00sNtmgbps}`
        },
        // Use a proper HTTP method
        method: 'post',
        // Format the credit card data to a string of key-value pairs
